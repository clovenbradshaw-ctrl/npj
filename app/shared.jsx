...
const I = {
  ...
  /* the sourcing glyph (⊨, the EVA operator): evidence that backs a claim — the double turnstile "models" */
  source:  (p) => (<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" strokeWidth="2.2" {...p}><path d="M6 4v16M6 9h13M6 15h13"/></svg>),
